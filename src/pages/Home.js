    ...
    return (
        <div className='home-page'>
            <div className='paragraph'>
                ...
                <img src={require('../assets/cocktails/hazelnutOldFashioned.jpg')} alt="hazelnut old fashioned" />
            </div>
            <br />
            <div className='paragraph'>
                <div className='text-content'>
                ...
                <img src={require('../assets/cocktails/newYorkSour.jpg')} alt="new york sour" />
            </div>
            <br />
            <div className='paragraph'>
                <div className='text-content'>
            ...
            <img src={require('../assets/cocktails/cadillacMargarita.jpg')} alt="hazelnut old fashioned" />
            </div>
        </div>
    )
}